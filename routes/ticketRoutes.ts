...
interface GenerateTicketRequest extends Request {
    body: {
        vatin: string;
        first_name: string;
        last_name: string;
...
router.post('/generate-ticket', async (req: GenerateTicketRequest, res: Response) => {
...
router.get('/ticket-count', async (req: Request, res: Response) => {
    try {
...
router.get('/ticket/:ticketId', requireAuth, async (req: Request, res: Response) => {
